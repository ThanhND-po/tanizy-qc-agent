...
- Keep installed skills in `.agents/skills/qc-*` and project-owned artifacts under `qc/`. Never install skills inside `qc/`.
...
Route only to a `qc-*` skill that exists in `.agents/skills/`.
